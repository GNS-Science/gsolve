    ...
    **kwargs
    ...
    def merge(
        ...
        *,
        ...
        """Merge a GravityObservations object into this .
        ...
        """
        if not isinstance(other, GravityObservations):
        ...
        new_grav_obs = GravityObservations.from_dataframe(combined_df, use_index=True)
